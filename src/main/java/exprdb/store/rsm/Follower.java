...
class Follower extends Participant {
  ...
  private static final Logger LOG = LogManager.getLogger(Follower.class);
  ...
  public Follower(ParticipantState participantState,
    ...
    ThreadContext.put("state", "following");
  }
  ...
  protected void changePhase(Phase phase) throws IOException {
    ...
    if (phase == Phase.DISCOVERING) {
      ThreadContext.put("phase", "discovering");
      ...
      ThreadContext.put("phase", "synchronizing");
      if (stateChangeCallback != null) {
        stateChangeCallback
      ...
      ThreadContext.put("phase", "broadcasting");
      if (stateChangeCallback != null) {
        stateChangeCallback
      ...
      ThreadContext.put("phase", "finalizing");
